...
#import "CollegeTable.h"
#import "College.h"

@implementation CollegeTable
...
{
    static NSString *CellIdentifier = @"Colleges Cell";
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if (self.searchDisplayController.active) {
        NSLog(@"Segue from the searchDisplayController, setting CollegeTable as a delegate of Detail within the searchResults array");
        ...
        NSLog(@"Segue from the fetchedResultsController, setting CollegeTable as a delegate of Detail");
        Detail *detail = segue.destinationViewController;
        detail.delegate = self;
        NSLog(@"Passing selected College (%@) to Detail", self.selectedCollege.name);
